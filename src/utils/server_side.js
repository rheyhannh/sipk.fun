    ...
    const check = async (limit, token) => {
            ...
            if (isTokenMax) {
                return Promise.reject(rateLimitError.maximum_token(
                    ...
                    undefined,
                    {
                        ...
                        functionResolvedVariable: { currentSize: tokenCache.size, sizeMax: tokenCache.max, isTokenMax },
        ...
        return isRateLimited ? Promise.reject(rateLimitError.maximum_usage(
            ...
            undefined,
            {
                ...
                functionArgs: { limit, token },
                functionResolvedVariable: { currentTtl, currentUsage, maximumUsage: limit, isRateLimited },
                request: await getRequestDetails(),
                more: null,
            },
            {
