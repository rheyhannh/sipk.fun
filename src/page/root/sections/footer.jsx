...
const footerSocials = [
	{
		...
		target: 'https://www.linkedin.com/company/sipk-app'
	},
	{
		icon: <FaTiktok size={'100%'} />,
		target: 'https://www.tiktok.com/@sipk.official'
	}
];
...
const FooterOutter = ({ children }) => (
	<div className={styles.footer_outter}>{children}</div>
);
				...
				<div className={styles.brand_wrap}>
					<motion.div
						...
						{...getFooterTransition(
							...
							0,
							false,
							viewportWidth <= FOOTER_SMALL_DEVICES
						)}
					>
