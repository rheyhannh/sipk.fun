...
export const HEADER_NAVIGATION_SHORCUTS =
	/** @type {Array<React.AnchorHTMLAttributes<HTMLAnchorElement> & import('next/link').LinkProps & import('@root_page/components').LinkHashProps>} */ ([
		{
			href: '/#universitas',
			text: 'Universitas',
			hashId: 'universitas',
 ...
 */
export const HERO_TITLE_PROPS =
	/** @type {import('@root_page/sections/hero').TitleProps} */ ({
		id: 'hero-title',
...
export const HERO_DESCRIPTION_TEXT =
	'SIPK memungkinkan kalian menyimpan seluruh matakuliah dengan SKS dan nilai yang kalian tentukan sendiri untuk memvisualisasikan perolehan IPK secara lebih fleksibel dan proaktif.';

/**
 * Array yang mendeskripsikan button yang digunakan pada section `Hero`
 */
export const HERO_BUTTONS =
	/** @type {Array<import('@root_page/sections/hero').ButtonItemProps>} */ ([
		{
			id: 'hero-cta-main',
			text: 'Mulai Sekarang',
 ...
 */
export const HERO_NOTIFIKASI_DUMMY_DATA =
	/** @type {Array<import('@/types/supabase').NotifikasiData>} */ ([
		{
			id: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
			title: 'Maintenance',
			description:
				'Mohon maaf atas ketidaknyamanannya🙏, SIPK akan melakukan perawatan sistem pada 22 November 2023 jam 19:30 WIB🌙',
		...
		},
		{
			...
			title: 'Announcement',
			description:
				'Jaga email dan password kamu, karna admin SIPK tidak pernah meminta email, password atau data pribadi kamu❗',
		...
		},
		{
			...
			title: 'Fitur Baru',
			description:
				'Hujan rintik ada payung, payungnya terbang kebekasi, daripada nyariin payung, Mending cek fitur baru disini🏃',
 ...
 * @type {string}
 */
export const UNIVERSITAS_SECTION_DESCRIPTION =
	'Saat ini, SIPK tersedia untuk mahasiswa dari {jumlah_universitas} universitas yang didukung. Apapun jurusan atau program pendidikanmu, selama universitasmu ada dalam daftar, kamu bisa menggunakan SIPK.';
...
export const UNIVERSITAS_ITEMS_LAYOUT = [
	{
		count: 1,
		style: { marginTop: 90, display: (x, y) => (x < 425 ? 'none' : 'block') }
	},
	{ count: 3, style: {} },
	...
	{
		count: 1,
		style: { marginBottom: 90, display: (x, y) => (x < 425 ? 'none' : 'block') }
	}
];
