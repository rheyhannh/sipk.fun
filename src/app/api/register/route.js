        ...
        if (!universitas.length) {
            throw notFoundError.resource_not_found(
                defaultUserErrorMessage, undefined,
                {
                    ...
                    stack: null,
                    functionDetails: 'supabase.from at POST /api/register line 64',
        ...
        if (!userUniversitasName) {
            throw notFoundError.resource_not_found(
                defaultUserErrorMessage, undefined,
                {
                    ...
                    stack: null,
                    functionDetails: 'POST /api/register line 109',
                    functionArgs: null,
                    functionResolvedVariable: null,
                    request: await getRequestDetails(),
                    more: null,
        ...
        if (error) {
            throw serverError.interval_server_error(
                defaultUserErrorMessage, undefined,
                {
                    ...
                    stack: null,
                    functionDetails: 'supabase.auth.signUp at POST /api/register line 127',
