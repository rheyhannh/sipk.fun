 ...
 */
const getCommonAnimationVariants = (type) => {
	const animations = {
		...
		throwUp: {
			hide: { opacity: 0, x: -200, y: 200, rotate: 30 },
		...
		scaleFromBig: {
			hide: { opacity: 0, scale: 1.5 },
			show: { opacity: 1, scale: 1 }
		},
		diagonalUpLeft: {
			hide: { opacity: 0, y: 75, x: 75 },
...
export { getCommonAnimationVariants };
