						...
						return new Promise(async (resolve, reject) => {
							try {
								...
								if (isEmpty(password, { ignore_whitespace: true })) {
									...
									if (!isLength(password, { min: 6, max: 50 })) {
										setErrorMessage('Password min 6, max 50 karakter');
										resolve(null);
									}
								}

								// Validating 'Password Confirm'
								if (isEmpty(passwordConfirm, { ignore_whitespace: true })) {
									setErrorMessage('Konfirmasi password dibutuhkan');
									resolve(null);
								} else {
									if (passwordConfirm !== password) {
										...
										>
											<div className={styles.form__input_field}>
												...
												<div className={styles.password__tool}>
													<div
														className={`${styles.password__level} ${getPasswordLevelStyles()}`}
													>
														<small />
													</div>
											...
											<div className={styles.form__input_field}>
												<div>
													<input
														...
														onPaste={(e) => {
															e.preventDefault();
															setErrorMessage(
																'Untuk keamanan, silahkan ketik ulang password barumu'
															);
															return false;
														}}
														disabled={!editPassword}
												...
												<div className={styles.password__tool}>
													<div
														className={`${styles.password__level} ${getPasswordConfirmLevelStyles()}`}
													>
														<small />
													</div>
													<div className={styles.password__eye}>
											...
											<div className={styles.form__input_field}>
												<div>
													<input
														...
														readOnly={true}
													/>
													<label htmlFor='roles' className={styles.form__label}>
														Status
													</label>
												</div>
											</div>
