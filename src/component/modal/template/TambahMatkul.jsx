...
const TambahMatkul = () => {
	...
	return (
		<ModalContext.Consumer>
			{
				/** @param {import('@/types/context').ModalContext<TambahMatkulModalData>} context */ (
					context
				) => {
						...
						return new Promise(async (resolve, reject) => {
							try {
								...
								resolve({
									...
									sks: Number(sks),
									nilai: {
										indeks: penilaianKey.find(
											(key) => `${penilaian[key].weight}` === `${nilai}`
										)
									},
					...
					return (
						<Backdrop>
							<Layout
								...
								onEsc={true}
								onEnter={(e, isLayout) => {
									if (isLayout) handleTambahMatkul(e);
								}}
										...
										<div className={styles.form__input_field}>
											...
											>
												...
												{penilaianKey.map((nilai, index) => (
													<option value={penilaian[nilai].weight} key={nilai}>
														{nilai}
													</option>
												))}
											</select>
