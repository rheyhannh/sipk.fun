...
const DEFAULT_TRUTHY_ICON = <FaRegCircleCheck size={'70px'} color={'var(--logo-second-color)'} />;
const DEFAULT_FALSY_ICON = <FaRegTimesCircle size={'70px'} color={'var(--logo-second-color)'} />;
...
const DEFAULT_FALSY_MESSAGE = 'Sepertinya ada yang salah saat memproses permintaanmu';
