...
export function Landing() {
    ...
    const onScrollRocketAnim = useTransform(scrollYProgress, [0, 1], ["0%", "-200%"]);
...
const Clouds = (
    ...
    return (
        ...
        >
            ...
            >
                <motion.div
                    style={{ y: onScrollAnimation.outter }}
                >
                    <Outter />
                </motion.div>
            </motion.div>
            ...
            >
                <motion.div
                    style={{ y: onScrollAnimation.center }}
                >
                    <Center />
                </motion.div>
            </motion.div>
            ...
            >
                <motion.div
                    style={{ y: onScrollAnimation.main }}
                >
                    <Main />
                    {children}
                </motion.div>
